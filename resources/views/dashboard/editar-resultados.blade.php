                ...
                <div class="col-md-10 mx-auto ">  
                    ...
                    <form action="{{ route('dashboard.update-resultado', ['id' => $result->id]) }}" method="POST">
                        ...
                        <div class="teste-create__form">
                            ...
                            <input type="text" name="title" id="title" class="title-quiz form-control  mb-4" placeholder="Digite o título" required value="{{$result->title}}">
    
                            <label for="score"> PONTUAÇÃO * </label>
                            <input type="text" name="score" id="score"  class="title-quiz form-control" placeholder="Digite a pontuação desse resultado" required value="{{$result->score}}">
